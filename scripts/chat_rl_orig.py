...
parser.add_argument("--source", type=str, default="sft", help="The phase of the source checkpoint.")
parser.add_argument("--dtype", type=str, default="bfloat16", help="The datatype to use. Only float32 and bfloat16 are supported.")
